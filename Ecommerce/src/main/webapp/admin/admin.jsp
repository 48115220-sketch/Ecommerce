            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-3">
                    ...
                    <div class="card shadow h-100 text-center p-4">
                        ...
                        <i class="bi bi-box-seam" style="font-size:60px;color:#556a32;"></i>
                        ...
                        <a href="<%=request.getContextPath()%>/admin/productosAdmin.jsp" class="btn btn-success">
                ...
                <div class="col-md-6 col-lg-3">
                    ...
                    <div class="card shadow h-100 text-center p-4">
                        ...
                        <i class="bi bi-people-fill" style="font-size:60px;color:#556a32;"></i>
                        ...
                        <a href="<%=request.getContextPath()%>/admin/usuariosAdmin.jsp" class="btn btn-success">
                ...
                <div class="col-md-6 col-lg-3">
                    ...
                    <div class="card shadow h-100 text-center p-4">
                        ...
                        <i class="bi bi-bag-check-fill" style="font-size:60px;color:#556a32;"></i>
                        ...
                        <a href="<%=request.getContextPath()%>/admin/comprasAdmin.jsp" class="btn btn-success">
                ...
                <div class="col-md-6 col-lg-3">
                    ...
                    <div class="card shadow h-100 text-center p-4">
                        ...
                        <i class="bi bi-bar-chart-fill" style="font-size:60px;color:#556a32;"></i>
                        ...
                        <a href="<%=request.getContextPath()%>/admin/dashboard.jsp" class="btn btn-success">
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-wrap gap-3 justify-content-center">
                                ...
                                <a href="<%=request.getContextPath()%>/admin/productoForm.jsp" class="btn btn-success">
