                ...
                <div class="card-body p-4">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 text-end">
                            ...
                            <button id="btnVaciar" class="btn btn-outline-danger me-2">
        ...
        <div class="container mb-5">
            ...
            <div class="row text-center">
                ...
                <div class="col-md-4">
                    ...
                    <i class="bi bi-shield-check" style="font-size:45px;color:#556a32;"></i>
                ...
                <div class="col-md-4">
                    ...
                    <i class="bi bi-truck" style="font-size:45px;color:#556a32;"></i>
                ...
                <div class="col-md-4">
                    ...
                    <i class="bi bi-arrow-repeat" style="font-size:45px;color:#556a32;"></i>
